...
def train_loop(epoch, dataloader, model, loss_fn, optimizer, device):
    ...
    torch.save(model, './models/model_0-5test_own_iter1_chinese.pkl')
...
if __name__ == "__main__":
    ...
    PRETRAINED_PATH = "./models/model_0-5test_own.pkl"        # 迁移学习：加载权重，用新数据微调
    ...
    train_dataset = CustomDataset('./images/chinese/train.txt', '', ToTensor)
